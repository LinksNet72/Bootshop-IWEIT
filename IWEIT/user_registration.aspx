<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLayout.Master" AutoEventWireup="true" CodeBehind="user_registration.aspx.cs" Inherits="IWEIT.user_registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div class="form-horizontal" >
		...
		<div class="controls">
            ...
            <asp:DropDownList ID="ddlMr" runat="server" CssClass="span1"></asp:DropDownList>
		</div>
		</div>
		<div class="control-group">
			<label class="control-label">First name <sup>*</sup></label>
			<div class="controls">
			  <input type="text" id="txtFname" placeholder="First Name" runat="server">
			</div>
		 </div>
		 <div class="control-group">
			<label class="control-label">Last name <sup>*</sup></label>
			<div class="controls">
			  <input type="text" id="txtLname" placeholder="Last Name" runat="server">
			</div>
		 </div>
		<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
		  <input type="password" id="inputPassword1" placeholder="Password" runat="server">
		</div>
	  </div>	  
		<div class="control-group">
